...
run(
   Filter(CTRL) >> CtrlSplit({
       ...
       #13: SendOSC(port, '/strip/MicSend/Gain/Gain%20(dB)', lambda ev: ev.value / 127.0),


       #Fader Volumes
       0: SendOSC(port, '/strip/Media/Gain/Gain%20(dB)', lambda ev: ev.value / 127.0),
       1: SendOSC(port, '/strip/Games/Gain/Gain%20(dB)', lambda ev: ev.value / 127.0),
       2: SendOSC(port, '/strip/Voip/Gain/Gain%20(dB)', lambda ev: ev.value / 127.0),
       3: SendOSC(port, '/strip/Microphone/Gain/Gain%20(dB)', lambda ev: ev.value / 127.0),
       4: SendOSC(port, '/strip/MicSend/Gain/Gain%20(dB)', lambda ev: ev.value / 127.0),
       5: SendOSC(port, '/strip/Master/Gain/Gain%20(dB)', lambda ev: ev.value / 127.0),
       6: SendOSC(port, '/strip/UMC-7/Gain/Gain%20(dB)', lambda ev: ev.value / 127.0),
       7: SendOSC(port, '/strip/UMC-8/Gain/Gain%20(dB)', lambda ev: ev.value / 127.0),
       ...
       #53: SendOSC(port, '/strip/Media/Gain/Mute', lambda ev: ev.value / 127.0),
       #54: SendOSC(port, '/strip/Voip/Gain/Mute', lambda ev: ev.value / 127.0),
       #55: SendOSC(port, '/strip/Master/Gain/Mute', lambda ev: ev.value / 127.0),
       #32: SendOSC(port, '/strip/Microphone/Gain/Mute', lambda ev: ev.value / 127.0),
